...
namespace CarDealershipSystem.Data.Migrations
{
    ...
    [Migration("20240407135404_FixingCarExtra")]
    partial class FixingCarExtra
    {
            ...
            modelBuilder.Entity("CarDealershipSystem.Data.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dfda3415-ef36-46a7-97a3-17092321a71f"),
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("3a9a6a0e-a28f-4775-9d6e-2c679744b571"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
